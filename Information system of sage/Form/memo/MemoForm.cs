...
namespace Information_system_of_sage
{
    public partial class MemoForm : Form
    {
        ...
        {
            printDocument1.DocumentName = txtMemo.Text; //문서 지정
        ...
        private void mi_Font_Click(object sender, EventArgs e)  //글꼴 메뉴 구현
        {
            ...
            txtMemo.ForeColor = fontDialog1.Color;  //글자 색 지정
        }
        #endregion
